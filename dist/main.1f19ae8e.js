...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"logic/globals.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ROW_SIZE = exports.PLAINS = exports.DIRECTIONS = exports.COLORS = void 0;
var ROW_SIZE = 3;
...
var cubeLogic = /*#__PURE__*/function () {
  ...
  _createClass(cubeLogic, [{
    key: "initializeCube",
    value: function initializeCube() {
      var _this = this;

      var i = 0;

      var _loop = function _loop(face) {
        var color = globals.COLORS[i];

        _toConsumableArray(Array(globals.ROW_SIZE)).map(function () {
          _this.cubeState[face].push(new Array(globals.ROW_SIZE).fill(color));
        });

        i++;
      };

      for (var face in this.cubeState) {
        _loop(face);
      }
    }
  }, {
    ...
    value: function rotate(axis, rowNum, direction) {
      ...
      if (axis === "x") this.rotateX(circularPlane, rowNum);else this.rotateYZ(circularPlane, rowNum);
    }
  }, {
    key: "rotateX",
    ...
    value: function shuffle() {
      ...
      _toConsumableArray(Array(numOfRotates)).forEach(function () {
        var axis = axes[_this4.random(3)];

        var row = _this4.random(globals.ROW_SIZE);

        var direction = Object.keys(globals.DIRECTIONS)[_this4.random(2)];

        console.log("axis: ".concat(axis, ", row: ").concat(row, ", direction: ").concat(direction));

        _this4.rotate(axis, row, direction);
      });
    }
  }, {
    key: "random",
...
},{"./globals":"logic/globals.js"}],"view/cubeVisual":[function(require,module,exports) {
module.exports="/133dffdffee6de97c2f92e3ea9adeafe.";
...
},{"./logic/cubeLogic":"logic/cubeLogic.js","./view/cubeVisual":"view/cubeVisual","./logic/globals":"logic/globals.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
